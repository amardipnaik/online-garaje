        ...
        <div class="col-xs-2">
          ...
          <!--   <ul class="nav nav-tabs tabs-left"> -->
               ...
               My Details
                  ...
                  <br><br>
                <button ng-click="route('/addUser.htm')" class="fiveup">
               Add User              
                </button>
                  <br><br>
                <button ng-click="route('/addGarage.htm')" class="fiveup">
              Add Garage             
                </button>
                 <br><br>
               ...
               User List              
                 ...
                 <br><br>
                <button ng-click="route('/viewGarage.htm')" class="fiveup">
               Garage List              
                </button>
                  <br><br>
                <button ng-click="route('/distanceApi.htm')" class="fiveup">
               Distance API Demo              
                </button>
                
                <br><br>
                  
               <button ng-click="route('/aboutUs.htm')" class="fiveup">
                About Us
                </button>
                 <br><br>
